...
import {PosteService} from "../../services/forum/poste.service";
...
export class ForumComponent implements OnInit {
  ...
  constructor(public authService: AuthenticationService, private posteService: PosteService, private formBuilder: FormBuilder, private router: Router) {
  }
  ...
  Details(postes: Postes) {
    this.router.navigateByUrl("/navbar/details-postes/" + postes.id, {state: postes});
  }
